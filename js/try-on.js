(() => {
  ...
  // ---------- Avatar (replace pipeline) ----------
  let pendingGarments = []; // if user picks clothes before avatar loads
  ...
  // If a rack/hanger is tapped before avatar exists, queue it
  const _wearGarment = wearGarment;
